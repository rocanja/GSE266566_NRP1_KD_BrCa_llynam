...
```{r}
rm(list=setdiff(ls(),c("nrp1.tpm","AA","nrp1.label","mygtf","level.order.treat","level.order.line","group.colors.treat","group.colors.line"))) #cleanup
```
...
```{r}
rm(list=setdiff(ls(),c("nrp1.tpm","AA","nrp1.label","nrp1.isopct","B","named.p36","mygtf","level.order.treat","level.order.line","group.colors.treat","group.colors.line"))) #cleanup
gc()
